...
strRangePaste = WScript.Arguments.Item(2)

'SN1 = WScript.Arguments.Item(3)
SN2 = WScript.Arguments.Item(3)
...
objWorkbook1.Worksheets(SN2).Range(strRangePaste).PasteSpecial 12

'objWorkbook1.Worksheets(SN2).Range(strRangePaste).PasteSpecial -4163
